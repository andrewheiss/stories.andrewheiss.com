...
- [**Viridis palettes**](https://cran.r-project.org/web/packages/viridis/vignettes/intro-to-viridis.html): R package for viridis palettes.
...
- [^r-google] [**Garrett Grolemund and Hadley Wickham, *R for Data Science***](http://r4ds.had.co.nz/): Fantastic introduction to R and the `tidyverse`, with some chapters specifically for data visualization.
