...
^[{-} [![Example rubric for final project](/images/rubrics/final-project_rubric.png)](/assignment/rubrics/final-project_rubric.pdf)] In the end, I need the following outputs from you:
...
Each element of the portfolio will be graded on how well you tell a story that is appropriate to its given audience, and (where applicable), how well you apply the principles of CRAP and data visualization. I will use [this rubric](/assignment/rubrics/final-project_rubric.pdf) to grade the final project.
