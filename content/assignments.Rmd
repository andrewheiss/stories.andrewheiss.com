...
- A three-tweet tweetstorm
- A single tweet^[A true 140-character tweet, not one of the new abonimable 280-character missives.]

## Story maps

Midway through the semester, you will map out the structure of your article and then create outlines for each of the parts of the story portfolio. You will receive peer feedback and feedback from me about the narrative structures you create.
...
Over the course of the semester, you will develop your own rubrics for evaluating the (1) design, (2) narrative, and (3) delivery of a presentation, based on the readings, assignments, and classroom activities you'll do. These rubrics can take any form you want, as long as they include some approach for scoring performance and some method for quickly identifying specific areas of improvement. Where possible, try to cite the materials you draw from to create the rubric items.

## Draft rubric

Draft rubrics will be due at the end of each of the major course sections. You'll get feedback about these drafts from your peers and me, but they will only be graded for completion. I will grade your final combined rubric according to a rubric I will provide you.

## Rubric test run

Before you turn in your final rubric, you'll need to make sure it actually works. Use your improved draft rubrics to evaluate any research presentation (a live one in another class, a TED talk, an extra on-campus seminar, etc.). You'll only be graded for completion.
